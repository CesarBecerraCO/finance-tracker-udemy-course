class UserStocksController < ApplicationController
  ...
  def create
    ...
    #Add the ability to create a new UserStock for an existing stock or a new one
    ...
    respond_to do |format|
      if @user_stock.save
        ...
        format.html { redirect_to my_portfolio_path, notice: "User #{@user_stock.stock.ticker} was successfully added." }
